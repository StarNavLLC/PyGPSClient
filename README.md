...
* Ubuntu 20.04.6 Executable for x64 - [pygpsclient](https://github.com/StarNavLLC/PyGPSClient/releases/download/1.5.6_pulsar/pygpsclient) 
* Windows 10 Executable for  x64 - [pygpsclient.exe](https://github.com/StarNavLLC/PyGPSClient/releases/download/1.5.6_pulsar/pygpsclient.exe) 
